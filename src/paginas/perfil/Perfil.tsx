...
import slide1 from '../../assets/slides1.png'
...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <img src={usuario.foto} alt={`Foto de perfil de ${usuario.foto}`} className='rounded-full w-56 mx-auto mt-[-8rem] border-8 border-white relative z-10' />
